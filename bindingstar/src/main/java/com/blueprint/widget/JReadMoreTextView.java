 ...
 * ======================================
 */
@SuppressLint("AppCompatCustomView") public class JReadMoreTextView extends TextView {
    ...
    private CharSequence trimCollapsedText = "更多";
    private CharSequence trimExpandedText = "收起";
    private ReadMoreClickableSpan viewMoreSpan;
    private int colorClickableText = Color.RED;
    private boolean showTrimExpandedText = true;

    private int trimMode = TRIM_MODE_LINES;
    private int lineEndIndex;
    private int trimLines;


    public JReadMoreTextView(Context context) {
        this(context, null);
    }


    public JReadMoreTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.trimLength = DEFAULT_TRIM_LENGTH;
        this.trimLines = getMaxLines();
    ...
    private CharSequence updateCollapsedText() {
        ...
        SpannableStringBuilder s = new SpannableStringBuilder(text, 0, trimEndIndex).append(ELLIPSIZE).append(trimCollapsedText);
