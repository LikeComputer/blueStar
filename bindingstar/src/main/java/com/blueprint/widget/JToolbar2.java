 ...
 * ======================================
 */
public class JToolbar2 extends Toolbar implements DoubleClickAble, GestureDetector.OnDoubleTapListener {
    ...
    public JToolbar2(Context context, @Nullable AttributeSet attrs){
        super(context, attrs);
        setClickable(true);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b){
        ...
        if(mTitleOrignLeft == 0 && shouldLayout(mTitleTextView)) {
            ...
            ( (LayoutParams)mTitleTextView.getLayoutParams() ).rightMargin = righMargin;
    ...
    public void setOnDoubleClickListener(OnDoubleClickListener dl){
