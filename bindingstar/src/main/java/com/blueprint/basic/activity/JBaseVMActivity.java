 ...
 * @date 2018/1/17.
 */
public abstract class JBaseVMActivity<VM extends ViewModel, DBI extends ViewDataBinding> extends JBaseActivity {
    /**
     * ContentView中 外层 父容器
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        if(checkIfNeedContent()) {
            //子类设置的 要显示的布局内容
            DBI contentViewDatabinding = onCreateContent(LayoutInflater.from(this), mContainerLayout);
    ...
    protected boolean checkIfNeedContent(){
        return true;
    }
